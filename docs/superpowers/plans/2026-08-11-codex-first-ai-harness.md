...
- the App Server summary records exact request-scoped clone trust, one raw four-argument spawn call correlated to one authoritative MultiAgentV2 item, the linked child ID, and the mandatory structured repository role source;
