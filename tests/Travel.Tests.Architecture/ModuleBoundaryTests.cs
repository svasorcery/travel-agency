...
public class ModuleBoundaryTests
{
    ...
    {
        Classes()
            .That().ResideInNamespaceMatching(@"Travel\.Modules\.Flights.*")
    ...
    {
        Classes()
            .That().ResideInNamespaceMatching(@"Travel\.Modules\.Hotels.*")
            .Should().NotDependOnAnyTypesThat()
    ...
    {
        Classes()
            .That().ResideInNamespaceMatching(@"Travel\.Modules\.Rail.*")
            .Should().NotDependOnAnyTypesThat()
    ...
    {
        Classes()
            .That().ResideInNamespaceMatching(@"Travel\.Modules\.Trips.*")
            .Should().NotDependOnAnyTypesThat()
